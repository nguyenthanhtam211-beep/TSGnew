...
const TAB_METADATA: Record<string, { label: string; group: string; groupTitle: string; icon: React.ReactNode }> = {
  ...
  pricing: { label: 'Bảng Giá & Đơn Giá Sản Phẩm (2026)', group: 'commercial', groupTitle: 'Thương Mại & Danh Mục', icon: <Package size={13} className="text-emerald-500" /> },
  ...
  commissions: { label: 'Quản Lý Hoa Hồng (3 Phương Thức)', group: 'commercial', groupTitle: 'Thương Mại & Danh Mục', icon: <Package size={13} className="text-purple-500" /> },
